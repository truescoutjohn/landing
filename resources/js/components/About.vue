<template>
  <div class="pt-[90px] xl:pt-[119px] text-alabastar-400 font-montserrat">
    <div class="mx-auto px-4 xl:px-[30px] text-center xl:max-w-[1380px]">
      ...
      <h2
        class="mx-auto mb-[18px] xl:mb-[36px] text-[22px] sm:text-[40px] xl:text-[48px] text-center max-w-[800px] xl:max-w-[1130px] font-semibold xl:leading-[59px] uppercase"
      >
        {{ about_title }}
      </h2>
      <p
        class="fade-text mx-auto mb-[16px] text-base xl:text-[20px] font-medium max-w-[800px] xl:leading-[24px]"
      >
        {{ about_content }}
      </p>
      <a href="#" class="inline-block font-bold uppercase mb-[64px]">Read more</a>
      <div
        class="flex flex-wrap justify-center xl:justify-between gap-x-12 gap-y-12 mx-auto max-w-[687px] mb-[24px]"
      >
      ...
      <div class="fade-img max-w-[1078px] mx-auto">
        <img :src="`/storage/${about_image}`" alt="romanovTeam" />
      </div>
    </div>
  </div>
</template>
